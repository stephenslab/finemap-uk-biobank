...
tmp = data.frame(POS = ss.dat$pos$POS, p = -log10(pval), ref = ss.dat$pos$POS == 141121814, r2 = R[which(ss.dat$pos$POS == 141121814),]^2)

ggplot(tmp, aes(x = POS, y = p, shape = ref, size=ref, color=r2)) + geom_point() + ylab("-log10(p)") +
