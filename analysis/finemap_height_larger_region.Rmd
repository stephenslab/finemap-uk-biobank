...
p1 = susie_plot_locuszoom(z, mod, ld = R[which(ss.dat$pos$POS == 141121814),], z.ref.name = 'rs2871960_C')
p2 = susie_plot_locuszoom(z, mod, ld = R[which(ss.dat$pos$POS == 141121814),], z.ref.name = 'rs2871960_C', y.susie ='p')
...
```{r}
ss.dat$pos[unlist(mod_bhat.ld$sets$cs$L1)]
```
