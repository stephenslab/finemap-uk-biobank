...
```{r CABLES1_bhat_nostandardize_results, fig.align='center', fig.width=45, fig.height=15}
...
Zoom in plot:
```{r CABLES1_bhat_nostandardize_results_CSszoomin, fig.align='center', fig.height=8, fig.width=10}
...
```{r CABLES1_bhat_nostandardize_CS2_1, warning=FALSE, fig.align='center', fig.height=8, fig.width=10}
