---
title: "Fine-mapping Height GDF5 -- SuSiE check"
author: "Yuxin Zou"
date: "10/07/2019"
output: 
  html_document:
...
We perform some check for the SuSiE result on region around GDF5
...
```{r GDF5_bhat_nostandardize_results, fig.align='center', fig.width=45, fig.height=15}
...
```{r GDF5_bhat_nostandardize_CS3_1, warning=FALSE, fig.align='center', fig.height=8, fig.width=20}
...
The residuals after removing the effects from CSs other than CS3 is
\[
r = y - \mathbf{X} \sum_{l=3}^{L}\hat{\mathbf{b}}_{l}.
\]
...
grid.arrange(p1,p2,ncol=2)
# pdf('GitHub/finemap-uk-biobank/GDF5_CS1.pdf', height=5, width=8)
# p2
# dev.off()
```
