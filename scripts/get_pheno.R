...
# associations. The output is a CSV file containing data for the
# selected phenotypes and samples. This should take at most 1-2 hours
# to run, and may require a good amount of memory (works well with
# about 24 GB, although may not require this much).
