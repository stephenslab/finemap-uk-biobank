...
plink2 --pfile ${outputfile} --threads 20 --memory 48000 --export A --out ${outputfile}

gzip ${outputfile}.raw

plink2 --pfile ${outputfile} --threads 20 --memory 48000 --freq --out ${outputfile}

plink2 --pfile ${outputfile} --threads 20 --memory 48000 --export bgen-1.2 --out ${outputfile}

ldstore --bgen ${outputfile}.bgen --bcor ${ldfile}.bcor --n-threads 20 --accuracy high --ld-thold 0 
ldstore --bcor ${ldfile}.bcor --merge 20
